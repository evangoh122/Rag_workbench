...
def test_get_stats_success(mock_db, mock_llm_tracker):
    ...
    # data: 6 counts + 2 stored-dimension aggregate fetchone calls + 1 fetchall
    # review: 4 counts
    mock_db.execute.return_value.fetchone.side_effect = [
        (100,), (10,), (50,), (5,), (200,), (150,), # data counts
        (1024, 1024, 1),                             # stored dimension aggregate
        (1024, 1024, 1, 31),                         # ticker dimension aggregate
        (20,), (15,), (5,), (2,) # review
    ]
    ...
    assert res_data["data"]["ticker_embedding_dim_min"] == 1024
    assert res_data["data"]["ticker_embedding_dim_max"] == 1024
    assert res_data["data"]["ticker_embedding_dim_variants"] == 1
    assert res_data["data"]["ticker_embeddings_with_vectors"] == 31
