    ...
    <div className="flex-1 flex flex-col h-full animate-in fade-in duration-300">
      ...
      <div className="px-4 lg:px-8 py-6 bg-gradient-to-t from-background via-background to-transparent flex-shrink-0 absolute bottom-0 left-0 right-0 pointer-events-none">
        <form
          ...
          className="max-w-4xl mx-auto flex items-center bg-surface-elevated border border-border rounded-2xl p-2 transition-all duration-300 focus-within:border-accent/60 focus-within:ring-4 focus-within:ring-accent/10 pointer-events-auto shadow-none"
        >
          <input
          ...
          <button
            ...
            className="flex items-center justify-center px-6 py-3 bg-accent-fill hover:bg-accent-fill-hover text-accent-ink rounded-xl border-0 cursor-pointer transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed font-semibold gap-2 ml-2"
          >
            Trace <Send size={16} />
          </button>
        </form>
